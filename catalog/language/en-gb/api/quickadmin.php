<?php
// Success
$_['login_success']         = 'Success: API session successfully started!';
$_['logout_success']        = 'Success: API session successfully finished!';
// Customer
$_['customer_added']        = 'Success: Customer #%s added!';
$_['customer_updated']      = 'Success: Customer #%s updated!';
$_['customer_deleted']      = 'Success: Customer #%s deleted!';
// Product
$_['product_added']         = 'Success: Product #%s added!';
$_['product_updated']       = 'Success: Product #%s updated!';
$_['product_deleted']       = 'Success: Product #%s deleted!';
// Order
$_['order_added']           = 'Success: Order #%s added!';
$_['order_updated']         = 'Success: Order #%s updated!';
$_['order_deleted']         = 'Success: Order #%s deleted!';
...
$_['error_product']          = 'Warning: Product details needs to be set!';
$_['error_order']            = 'Warning: Order details needs to be set!';
